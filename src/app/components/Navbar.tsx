...
export default function Navbar() {
  ...
  // Updated navigation items to include 'Home'
  const navItems = [
    { name: "Home", href: "/" },
        ...
        >
          {navItems.map((item, index) => (
            <Link key={index} href={item.href} passHref>
              <motion.div
                className="relative text-lg text-gray-200 font-semibold block mt-4 md:mt-0 text-center md:text-left cursor-pointer"
